...
class AplicacionBusquedaSalas2:
    ...
    def __init__(self, root, admin_salones,usuario_actual):
        ...
        self.bregresar = tk.Button(self.root, image=self.photo1, command=self.abrir_ventana, border=0)
    ...
    #logica para el nombre del usuario
        ...
        label_usuario = tk.Label(root, text=f"ESTUDIANTE", fg="black", bg="white", font=("times", 10))
        ...
        self.label_img5.place(x=15,y=10)
    ...
    def abrir_ventana(self):
        ...
        ventana_actualizar = VentanaOpciones()
    def microfono(self):
    ...
    def mostrar_informacion_sala(self, sala): 
            ...
            ventana_info_sala.attributes('-fullscreen', True)
        ...
        #logica para el nombre del usuario
            ...
            """self.bregresar = tk.Button(ventana_info_sala, width=60, height=2,text="¿Te equivocaste de salon?, Cambialo aqui", command=self.regresar, bg="#222feb", fg="white", border=0)
            self.bregresar.place(x=800,y=590)"""
    ...
    def guardar_ruta(self):
        ...
        if ruta:
            ...
            messagebox.showinfo("Éxito", "Ruta guardada correctamente.")
            # print("SISASSS", self.usuario_actual2)
...
if __name__ == "__main__":
    ...
    app = AplicacionBusquedaSalas2(root, admin_salones, usuario_actual)
